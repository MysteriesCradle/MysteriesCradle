...
<form>
  <div class="mb-3">
    ...
    <center><input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required></center>
    <div></div>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Senha</label>
    <center><input type="password" class="form-control" id="exampleInputPassword1" required></center>
  </div>
  <div class="mb-3 form-check">
    <input type="checkbox" class="form-check-input" id="exampleCheck1" required>
    <label class="form-check-label" for="exampleCheck1"> <p>Clique aqui se você concorda com os <a href="">termos de </p><p>serviço </a></p> </label>
  </div>
  <button type="submit" class="btn btn-dark">Entrar</button><br><br>
  <a class="a" href="Cadastro.php">Criar Nova Conta</a>
  <a class="a" href="../index.php">volta á pagina inicial</a>
</form>
    <footer>
